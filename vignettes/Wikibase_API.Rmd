...
key_set_with_value(service = "https://reprexbase.eu/example/api.php", 
...
```{r keyget, eval=FALSE}
key_get(service = "https://reprexbase.eu/example/api.php", 
...
my_csrf <- get_csrf(
  username="Demo@adminbot",
  password = key_get(service = "https://reprexbase.eu/example/api.php",
                     username = "Demo@adminbot" ),
