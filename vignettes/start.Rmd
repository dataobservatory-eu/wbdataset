...
The `equivalence_property`, as you will see later, can help you connect your new node to a  node on Wikidata, which later allows federation, and of course, data validation, or keeping your data refreshable. 
...
For repeated queries, you can place the repeating variables into a list, and 
provide this parameters as a list with `wikibase_session`=`my_wikibase_session`.
